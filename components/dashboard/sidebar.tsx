...
export function DashboardSidebar({ profile, subscription }: Props) {
  ...
  return (
    <aside className="w-64 flex flex-col border-r border-white/10 bg-slate-950/80 backdrop-blur-sm flex-shrink-0">
      {/* Logo */}
      ...
      {/* Plan badge */}
      {subscription && (
        <div className="mx-3 mb-3 p-3 glass rounded-xl border-white/5">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-slate-400">Votre plan</span>
