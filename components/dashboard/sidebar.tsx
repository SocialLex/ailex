      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <Icon size={18} className={active ? "text-cyan-500 dark:text-cyan-400" : "text-slate-400 dark:text-slate-500 group-hover:text-slate-600 dark:group-hover:text-slate-300"} />
              {item.label}
